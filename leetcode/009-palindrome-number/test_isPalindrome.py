...
from solution_isPalindrome import Solution
...
def test_isPalindrome(test_case):
    """Data-driven test for Palindrome Number problem."""
    solution = Solution()
    result = solution.isPalindrome(test_case["input"]["x"])
