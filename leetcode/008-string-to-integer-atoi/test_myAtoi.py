...
from solution_myAtoi import Solution
...
def test_myAtoi(test_case):
    """Data-driven test for String to Integer (atoi) problem."""
    solution = Solution()
    result = solution.myAtoi(test_case["input"]["s"])
